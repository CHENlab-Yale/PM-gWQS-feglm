...
#### Cleaned R code for the Sensitivity analyses: Temperature (df = 3)                                                                    ####
...
covar_name <- c("temp1", "temp2", "temp3")
...
model.data <- data.frame(y = death.rate,
                         ...
                         SO4 = SO4,
                         SOIL = SOIL,
                         temp1 = ns(temp.mean,3)[,1],
                         temp2 = ns(temp.mean,3)[,2],
                         temp3 = ns(temp.mean,3)[,3],
...
saveRDS(result, file = paste0(save.path, "result_sa_tdf3.rds"))