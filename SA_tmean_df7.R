...
#### Cleaned R code for the Sensitivity analyses: Temperature (df = 7)                                                                    ####
...
covar_name <- c("temp1", "temp2", "temp3", "temp4", "temp5", "temp6", "temp7")
...
model.data <- data.frame(y = death.rate,
                         ...
                         SO4 = SO4,
                         SOIL = SOIL,
                         temp1 = ns(temp.mean,7)[,1],
                         temp2 = ns(temp.mean,7)[,2],
                         temp3 = ns(temp.mean,7)[,3],
                         temp4 = ns(temp.mean,7)[,4],
                         temp5 = ns(temp.mean,7)[,5],
                         temp4 = ns(temp.mean,7)[,6],
                         temp5 = ns(temp.mean,7)[,7],
...
saveRDS(result, file = paste0(save.path, "result_sa_tdf7.rds"))